...
<head>
    ...
    <title>Crée son entreprise en 10 étapes</title>
    ...
    <main>
        ...
        <section>
            ...
            <article>
                ...
                <p>N'aie pas peur ! L’étude de marché à beau être fastidieuse à réaliser, elle est pourtant indispensable et elle à pour but de mesurer la « faisabilité » de ton projet.
            ...
            <article>
                <h2>Étape 4 : Les prévisions financières</h2>
                <p>Une étape indispensable pour l’aboutissement de ton projet d'entrepreneuriat, afin que tu puisses déterminer la pérennité de ta future entreprise, cette étape sera déterminante pour la suite ou non de ton projet.

                    C’est le moment de faire un choix, quel sera le modèle économique de ton entreprise ?
                    Car la priorité numéro un reste le profit, il te faudra décider de quelle façon tu vas faire gagner de l’argent à ton entreprise. Voici une série de question à te poser afin de faire le bon choix :
                    ...
                    Quel est le montant minimum à facturer pour le/les service(s) ou produit(s) que je vais fournir afin que dès la fin de la première année d’activité, je puisse faire face aux charges ?
            ...
            <article>
                ...
                <p>Depuis plusieurs années les formalités de création d’entreprise sont devenues presque un plaisir, oui presque ont à dit. Plusieurs solutions s’offres à toi à ce point ci, tu peut te rendre sur le portail guichet-entreprises.fr afin de réaliser toutes les démarches sur internet, ou tu peux, pour plus d’accompagnement, te rendre au Centre de Formalités de Entreprises (CFE).

                    Au CFE tout est fait pour centraliser tes démarches, c’est le centre qui s'occupera de prévenir toutes les administrations impliquées dans la réalisation de ton projet. Le but de ces démarches est l’obtention du précieux numéro d'immatriculation qui permet à ton entreprise d’exister juridiquement parlant.

                    Cependant veille à rédiger ton statut et à publier une annonce légale avant de te rendre au CFE.
                </p>
            </article>
            <article>
                <h2>Étape 9 : Installe ton entreprise </h2>
                <p>Les choses concrètes ! Enfin ! Depuis le début de ton parcours tu as été confronté à une multitude d’étapes plus ou moins tangibles, mais pas d’inquiétude, voilà le concret.
